...
def calculate_intervariability_per_patient(csv_input):
...
if __name__ == '__main__':
    input_csv = 'D:\DL_ECHO\LVOT_point_detection\predictions\GE1408_HMLHMLAVA___Mar11_14-43-45_EFFIB2UNETIMGN_DSNT_ADAM_LR5_AL_T-GE1408_HMLHMLAVA_V-NONE_EP30_LR0.003_BS32_VAL\COORD_DATA.txt'
    output_csv = ''

    calculate_intervariability_per_patient(input_csv)