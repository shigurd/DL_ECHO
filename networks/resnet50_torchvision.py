from .resnet50_utils._utils import IntermediateLayerGetter
from .resnet50_utils._internally_replaced_utils import load_state_dict_from_url
from .resnet50_utils import mobilenetv3
from .resnet50_utils import resnet
from .resnet50_utils.deeplabv3 import DeepLabHead, DeepLabV3
from .resnet50_utils.fcn import FCN, FCNHead
from .resnet50_utils.lraspp import LRASPP
...
def _segm_model(name, backbone_name, in_channels, num_classes, aux, pretrained_backbone=False):
...
def _load_model(arch_type, backbone, pretrained, progress, in_channels, num_classes, aux_loss, **kwargs):
    ...
    model = _segm_model(arch_type, backbone, in_channels, num_classes, aux_loss, **kwargs)
    if pretrained:
...
def fcn_resnet50(pretrained=False, progress=True, in_channels=3,
